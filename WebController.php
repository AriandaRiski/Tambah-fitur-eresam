...
class WebController extends Controller
{
    ...
    public function dashboard(Request $request){
         ...
         // $wrdata = WajibRetribusi::where('is_active',1)->count();
          //$wrdatadua = WajibRetribusi::where('is_active',0)->count();
          
          $wrdata = WajibRetribusi::where('gampong',1)->count();
          $wrdata1 = WajibRetribusi::where('kota',1)->count();
          $wrjumlah = $wrdata + $wrdata1;
          $wrBelumVerif = $wr - $wrjumlah;
        

        return view('admin.layout.dashboard',compact('wr','petugas','koordinator','wrdata','wrdata1','wrjumlah','wrBelumVerif'))->with(["page" => "Dashboard"]);
